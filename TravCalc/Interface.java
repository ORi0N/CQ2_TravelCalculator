...
public class Interface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblWelcome.setText("For using this TravelCalc, you will need:");

        lblWelcome2.setText("- the latest version of this application.");

        lblWelcome3.setText("- an activated account on http://cq2.stormy.be/");

        lblWelcome4.setText("- your list updated at http://cq2.stormy.be/");
        ...
        lblInfo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/TravCalc/splash.png"))); // NOI18N
...
// TODO add your handling code here:
    ...
    private void formWindowClosing(java.awt.event.WindowEvent evt) {
        ...
        try {
            if (!username.equals("") && StatId > 0) {

                if (TravStatChoice) {
                    URL sim = new URL("http://cq2.stormy.be/calcget/travstat.php?action=logout&user=" + username + "&pass=" + userpass + "&statid=" + StatId + "&gcalcs=" + AantalGoodCalcs + "&bcalcs=" + AantalBadCalcs + "&gbrim=" + Brim + "&gcrys=" + Crys + "&gess=" + Ess + "&ggran=" + Gran + "&gbrim2=" + Brim2.toString() + "&gcrys2=" + Crys2.toString() + "&gess2=" + Ess2.toString() + "&ggran2=" + Gran2.toString());
            ...
            theLogger.severe("ERROR: " + e.toString());
        }
    }
    ...
    private void DoLogin() {
        ...
        if (checkLogin(username, userpass)) {
            ...
            try {
                ...
                BufferedReader in = new BufferedReader(new InputStreamReader(sim.openStream()));
                ...
                try {
                    if (TravStatChoice && StatId == 0) {
                        ...
                        BufferedReader statread = new BufferedReader(new InputStreamReader(urlstat.openStream()));
...
// TODO add your handling code here:
    ...
    private boolean checkLatestVersion() {
        ...
        try {
            URL sim = new URL("http://cq2.stormy.be/calcget/version.php?appversion=" + AppVersion);

            BufferedReader in = new BufferedReader(new InputStreamReader(sim.openStream()));
            inputLine = in.readLine();
            in.close();
        } catch (java.io.IOException e) {
            theLogger.severe("ERROR: VERSIONING ERROR: " + e.toString());
        }

        if (inputLine.equals(AppVersion)) {
            return true;
        } else {
            return false;
        }
...
//        }
    ...
    private int doBattle(Crit crit1, Crit crit2) {
        ...
        /* MaIm/Mabe crit1 ophalen */
        if (crit1.getMaIm().length() > 0) {
            if ((crit1.getMaIm()).equals(crit2.getFamily())) {

                def1 = 100; /* set to 100 */

                /* AIR crit1: dragons */
                if (crit1.getItem().equals("EaDrSc") || crit1.getItem().equals("Earth Dragon Scales") && crit2.getType().equals("earth")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("DeDrSc") || crit1.getItem().equals("Death Dragon Scales") && crit2.getType().equals("death")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("AiDrSc") || crit1.getItem().equals("Air Dragon Scales") && crit2.getType().equals("air")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("FoDrSc") || crit1.getItem().equals("Forest Dragon Scales") && crit2.getType().equals("forest")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("EaDrAr") || crit1.getItem().equals("Earth Dragon Armor") && crit2.getType().equals("earth")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("DeDrAr") || crit1.getItem().equals("Death Dragon Armor") && crit2.getType().equals("death")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("AiDrAr") || crit1.getItem().equals("Air Dragon Armor") && crit2.getType().equals("air")) {
                    def1 += 40;
                } else if (crit1.getItem().equals("FoDrAr") || crit1.getItem().equals("Forest Dragon Armor") && crit2.getType().equals("forest")) {
                    def1 += 40;
                } /* AIR crit1: storms */ else if (crit1.getItem().equals("EaStEn") || crit1.getItem().equals("Earth Storm Enhancer")) {
                    if (crit2.getType().equals("earth")) {
                        def1 -= 20;
                    } else {
                        def1 += 20;
                    }
                } else if (crit1.getItem().equals("DeStEn") || crit1.getItem().equals("Death Storm Enhancer")) {
                    if (crit2.getType().equals("death")) {
                        def1 -= 25;
                    } else {
                        def1 += 25;
                    }
                } else if (crit1.getItem().equals("AiStEn") || crit1.getItem().equals("Air Storm Enhancer")) {
                    if (crit2.getType().equals("air")) {
                        def1 -= 25;
                    } else {
                        def1 += 25;
                    }
                } else if (crit1.getItem().equals("EaStAu") || crit1.getItem().equals("Earth Storm Augmenter")) {
                    if (crit2.getType().equals("earth")) {
                        def1 -= 35;
                    } else {
                        def1 += 35;
                    }
                } else if (crit1.getItem().equals("DeStAu") || crit1.getItem().equals("Death Storm Augmenter")) {
                    if (crit2.getType().equals("death")) {
                        def1 -= 35;
                    } else {
                        def1 += 35;
                    }
                } else if (crit1.getItem().equals("AiStAu") || crit1.getItem().equals("Air Storm Augmenter")) {
                    if (crit2.getType().equals("air")) {
                        def1 -= 40;
                    } else {
                        def1 += 40;
        ...
        } else if (crit1.getMaBe().length() > 0) {
            if ((crit1.getMaBe()).equals(crit2.getFamily())) {
                damage1 = damage1 * (2.1); /* ATTENTION ORi not tested */
            }
        }

        /* MaIm/Mabe crit2 ophalen */
        if (crit2.getMaIm().length() > 0) {
            if ((crit2.getMaIm()).equals(crit1.getFamily())) {
                def2 = 100; /* set to 100 */

                /* AIR crit2: dragons */
                if (crit2.getItem().equals("EaDrSc") || crit2.getItem().equals("Earth Dragon Scales") && crit1.getType().equals("earth")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("DeDrSc") || crit2.getItem().equals("Death Dragon Scales") && crit1.getType().equals("death")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("AiDrSc") || crit2.getItem().equals("Air Dragon Scales") && crit1.getType().equals("air")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("FoDrSc") || crit2.getItem().equals("Forest Dragon Scales") && crit1.getType().equals("forest")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("EaDrAr") || crit2.getItem().equals("Earth Dragon Armor") && crit1.getType().equals("earth")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("DeDrAr") || crit2.getItem().equals("Death Dragon Armor") && crit1.getType().equals("death")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("AiDrAr") || crit2.getItem().equals("Air Dragon Armor") && crit1.getType().equals("air")) {
                    def2 += 40;
                } else if (crit2.getItem().equals("FoDrAr") || crit2.getItem().equals("Forest Dragon Armor") && crit1.getType().equals("forest")) {
                    def2 += 40;
                } /* AIR crit2: storms */ else if (crit2.getItem().equals("EaStEn") || crit2.getItem().equals("Earth Storm Enhancer")) {
                    if (crit1.getType().equals("earth")) {
                        def2 -= 20;
                    } else {
                        def2 += 20;
                    }
                } else if (crit2.getItem().equals("DeStEn") || crit2.getItem().equals("Death Storm Enhancer")) {
                    if (crit1.getType().equals("death")) {
                        def2 -= 25;
                    } else {
                        def2 += 25;
                    }
                } else if (crit2.getItem().equals("AiStEn") || crit2.getItem().equals("Air Storm Enhancer")) {
                    if (crit1.getType().equals("air")) {
                        def2 -= 25;
                    } else {
                        def2 += 25;
                    }
                } else if (crit2.getItem().equals("EaStAu") || crit2.getItem().equals("Earth Storm Augmenter")) {
                    if (crit1.getType().equals("earth")) {
                        def2 -= 35;
                    } else {
                        def2 += 35;
                    }
                } else if (crit2.getItem().equals("DeStAu") || crit2.getItem().equals("Death Storm Augmenter")) {
                    if (crit1.getType().equals("death")) {
                        def2 -= 35;
                    } else {
                        def2 += 35;
                    }
                } else if (crit2.getItem().equals("AiStAu") || crit2.getItem().equals("Air Storm Augmenter")) {
                    if (crit1.getType().equals("air")) {
                        def2 -= 40;
                    } else {
                        def2 += 40;
        ...
        } else if (crit2.getMaBe().length() > 0) {
            if ((crit2.getMaBe()).equals(crit1.getFamily())) {
                damage2 = damage2 * (2.1); /* ATTENTION ORi not tested */
            }
        }

        /* CRIT1: items voor prebattle */

        /* crit1: lich items */
        if (crit1.getItem().equals("SaKn") || crit1.getItem().equals("Sacrifical Knife")) {
            def2 -= 10;
        } else if (crit1.getItem().equals("GoKn") || crit1.getItem().equals("Gore Knife")) {
            def2 -= 14;
        } else if (crit1.getItem().equals("BlKn") || crit1.getItem().equals("Blood Knife")) {
            def2 -= 18;
        } else if (crit1.getItem().equals("ShKn") || crit1.getItem().equals("Shadow Knife")) {
            def2 -= 22;
        } else if (crit1.getItem().equals("HeKn") || crit1.getItem().equals("Hell Knife")) {
            def2 -= 26;
        } else if (crit1.getItem().equals("OvBl") || crit1.getItem().equals("Overseer Blade")) {
            def2 -= 30;
        }


        /* crit1: smith */
        if (crit1.getItem().equals("BlCrMa") || crit1.getItem().equals("Black Crystal Maul")) {
            if (crit2.getType().equals("death")) {
                health1 += 750;
            } else {
                health1 += 500;
            }
        } else if (crit1.getItem().equals("BlCrHa") || crit1.getItem().equals("Black Crystal Hammer")) {
            if (crit2.getType().equals("earth")) {
                health1 += 750;
            } else {
                health1 += 500;
            }
        } else if (crit1.getItem().equals("DaBrHa") || crit1.getItem().equals("Dark Brim Hammer")) {
            if (crit2.getType().equals("air")) {
                damage1 += 450;
            } else {
                damage1 += 300;
            }
        } else if (crit1.getItem().equals("DaBrMa") || crit1.getItem().equals("Dark Brim Maul")) {
            if (crit2.getType().equals("forest")) {
                damage1 += 450;
            } else {
                damage1 += 300;
            }
        } else if (crit1.getItem().equals("DiMa") || crit1.getItem().equals("Disease Maul")) {
            if (crit2.getType().equals("death")) {
                damage1 += 600;
            } else {
                damage1 += 400;
            }
        } else if (crit1.getItem().equals("DiHa") || crit1.getItem().equals("Disease Hammer")) {
            if (crit2.getType().equals("earth")) {
                damage1 += 600;
            } else {
                damage1 += 400;
            }
        } else if (crit1.getItem().equals("SiHa") || crit1.getItem().equals("Sickness Hammer")) {
            if (crit2.getType().equals("air")) {
                health1 += 1200;
            } else {
                health1 += 800;
            }
        } else if (crit1.getItem().equals("SiMa") || crit1.getItem().equals("Sickness Maul")) {
            if (crit2.getType().equals("forest")) {
                health1 += 1200;
            } else {
                health1 += 800;
            }
        } /* CRIT1: MASS CRITS */ /* crit1: diabolic horde */ else if (crit1.getItem().equals("DiPe") || crit1.getItem().equals("Diabolic Pendant")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (30 * (tel));
        } else if (crit1.getItem().equals("DiFl") || crit1.getItem().equals("Diabolic Flag")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (35 * (tel));
        } else if (crit1.getItem().equals("DiBa") || crit1.getItem().equals("Diabolic Banner")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (41 * (tel));
        } else if (crit1.getItem().equals("DiSt") || crit1.getItem().equals("Diabolic Standard")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (46 * (tel));
        } else if (crit1.getItem().equals("DiCa") || crit1.getItem().equals("Diabolic Carrier")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (52 * (tel));
        } else if (crit1.getItem().equals("DiFl") || crit1.getItem().equals("Diabolic Flame")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (58 * (tel));
        } else if (crit1.getItem().equals("DiIn") || crit1.getItem().equals("Diabolic Inferno")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (64 * (tel));
        } else if (crit1.getItem().equals("DiAb") || crit1.getItem().equals("Diabolic Abyss")) {
            int tel = countCritFamily(1, crit1.getFamily());
            damage1 += (76 * (tel));
        } /* crit1: cleric */ else if (crit1.getItem().equals("SpRu") || crit1.getItem().equals("Spider Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (45 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (3 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("ViRu") || crit1.getItem().equals("Viper Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (60 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (6 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("RaRu") || crit1.getItem().equals("Raptor Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (70 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (9 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("DiRu") || crit1.getItem().equals("Disciple Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (78 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (19 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("ZeRu") || crit1.getItem().equals("Zealot Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (86 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (24 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("MiRu") || crit1.getItem().equals("Mirage Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (97 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (29 * (rest)); /* verlager met aantal andere crits */
        } else if (crit1.getItem().equals("DeRu") || crit1.getItem().equals("Delusion Rune")) {
            int tel = countCritFamily(1, crit1.getFamily());
            int rest = CritAantal - tel;
            damage1 += (108 * (tel)); /* verhogen met aantal clerics */
            damage1 -= (34 * (rest)); /* verlager met aantal andere crits */
        } /* crit1: fiend */ else if (crit1.getItem().equals("FeIn") || crit1.getItem().equals("Ferocious Infusion")) {
            int tel = countCritFamily(3, crit1.getName());
            //int tel =1;
            int rest = CritAantal - tel;
            damage1 += 250; /* verhogen */
            health1 += 250;
            damage1 -= (60 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (60 * (tel - 1));
        } else if (crit1.getItem().equals("BeIn") || crit1.getItem().equals("Berserker Infusion")) {
            int tel = countCritFamily(3, crit1.getName());
            int rest = CritAantal - tel;
            damage1 += 300; /* verhogen */
            health1 += 300;
            damage1 -= (75 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (75 * (tel - 1));
        } else if (crit1.getItem().equals("ThIn") || crit1.getItem().equals("Thrasher Infusion")) {
            int tel = countCritFamily(3, crit1.getName());
            int rest = CritAantal - tel;
            damage1 += 350; /* verhogen */
            health1 += 350;
            damage1 -= (85 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (85 * (tel - 1));
        } else if (crit1.getItem().equals("MaIn") || crit1.getItem().equals("Marauder Infusion")) {
            int tel = countCritFamily(3, crit1.getName());
            int rest = CritAantal - tel;
            damage1 += 400; /* verhogen */
            health1 += 400;
            damage1 -= (100 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (100 * (tel - 1));
        } else if (crit1.getItem().equals("MaIn") || crit1.getItem().equals("Mauler Infusion")) { /* ATTENTION ORI */
            int tel = countCritFamily(3, crit1.getName());
            int rest = CritAantal - tel;
            damage1 += 400; /* verhogen */
            health1 += 400;
            damage1 -= (100 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (100 * (tel - 1));
        } else if (crit1.getItem().equals("DeIn") || crit1.getItem().equals("Destroyer Infusion")) {
            int tel = countCritFamily(3, crit1.getName());
            int rest = CritAantal - tel;
            damage1 += 600; /* verhogen */
            health1 += 600;
            damage1 -= (150 * (tel - 1)); /* verlagen met aantal zelfde */
            health1 -= (150 * (tel - 1));
        }


        /* CRIT2: items voor prebattle */

        /* crit2: lich items */
        if (crit2.getItem().equals("SaKn") || crit2.getItem().equals("Sacrifical Knife")) {
            def1 -= 10;
        } else if (crit2.getItem().equals("GoKn") || crit2.getItem().equals("Gore Knife")) {
            def1 -= 14;
        } else if (crit2.getItem().equals("BlKn") || crit2.getItem().equals("Blood Knife")) {
            def1 -= 18;
        } else if (crit2.getItem().equals("ShKn") || crit2.getItem().equals("Shadow Knife")) {
            def1 -= 22;
        } else if (crit2.getItem().equals("HeKn") || crit2.getItem().equals("Hell Knife")) {
            def1 -= 26;
        } else if (crit2.getItem().equals("OvBl") || crit2.getItem().equals("Overseer Blade")) {
            def1 -= 30;
        }

        /* crit2: smith */
        if (crit2.getItem().equals("BlCrMa") || crit2.getItem().equals("Black Crystal Maul")) {
            if (crit1.getType().equals("death")) {
                health2 += 750;
            } else {
                health2 += 500;
            }
        } else if (crit2.getItem().equals("BlCrHa") || crit2.getItem().equals("Black Crystal Hammer")) {
            if (crit1.getType().equals("earth")) {
                health2 += 750;
            } else {
                health2 += 500;
            }
        } else if (crit2.getItem().equals("DaBrHa") || crit2.getItem().equals("Dark Brim Hammer")) {
            if (crit1.getType().equals("air")) {
                damage2 += 450;
            } else {
                damage2 += 300;
            }
        } else if (crit2.getItem().equals("DaBrMa") || crit2.getItem().equals("Dark Brim Maul")) {
            if (crit1.getType().equals("forest")) {
                damage2 += 450;
            } else {
                damage2 += 300;
            }
        } else if (crit2.getItem().equals("DiMa") || crit2.getItem().equals("Disease Maul")) {
            if (crit1.getType().equals("death")) {
                damage2 += 600;
            } else {
                damage2 += 400;
            }
        } else if (crit2.getItem().equals("DiHa") || crit2.getItem().equals("Disease Hammer")) {
            if (crit1.getType().equals("earth")) {
                damage2 += 600;
            } else {
                damage2 += 400;
            }
        } else if (crit2.getItem().equals("SiHa") || crit2.getItem().equals("Sickness Hammer")) {
            if (crit1.getType().equals("air")) {
                health2 += 1200;
            } else {
                health2 += 800;
            }
        } else if (crit2.getItem().equals("SiMa") || crit2.getItem().equals("Sickness Maul")) {
            if (crit1.getType().equals("forest")) {
                health2 += 1200;
            } else {
                health2 += 800;
            }
        } /* CRIT 2: MASS CRITS */ /* crit2: diabolic horde */ else if (crit2.getItem().equals("DiPe") || crit2.getItem().equals("Diabolic Pendant")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (30 * (tel));
        } else if (crit2.getItem().equals("DiFl") || crit2.getItem().equals("Diabolic Flag")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (35 * (tel));
        } else if (crit2.getItem().equals("DiBa") || crit2.getItem().equals("Diabolic Banner")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (41 * (tel));
        } else if (crit2.getItem().equals("DiSt") || crit2.getItem().equals("Diabolic Standard")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (46 * (tel));
        } else if (crit2.getItem().equals("DiCa") || crit2.getItem().equals("Diabolic Carrier")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (52 * (tel));
        } else if (crit2.getItem().equals("DiFl") || crit2.getItem().equals("Diabolic Flame")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (58 * (tel));
        } else if (crit2.getItem().equals("DiIn") || crit2.getItem().equals("Diabolic Inferno")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (64 * (tel));
        } else if (crit2.getItem().equals("DiAb") || crit2.getItem().equals("Diabolic Abyss")) {
            int tel = countCritFamily(2, crit2.getFamily());
            damage2 += (76 * (tel));
        } /* crit2: cleric */ else if (crit2.getItem().equals("SpRu") || crit2.getItem().equals("Spider Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (45 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (3 * (rest)); /* verlager met aantal andere crits */
        } else if (crit2.getItem().equals("ViRu") || crit2.getItem().equals("Viper Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (60 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (6 * (rest)); /* verlager met aantal andere crits */
            System.out.println("miep: " + damage2);
        } else if (crit2.getItem().equals("RaRu") || crit2.getItem().equals("Raptor Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (70 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (9 * (rest)); /* verlager met aantal andere crits */
        } else if (crit2.getItem().equals("DiRu") || crit2.getItem().equals("Disciple Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (78 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (19 * (rest)); /* verlager met aantal andere crits */
        } else if (crit2.getItem().equals("ZeRu") || crit2.getItem().equals("Zealot Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (86 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (24 * (rest)); /* verlager met aantal andere crits */
        } else if (crit2.getItem().equals("MiRu") || crit2.getItem().equals("Mirage Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (97 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (29 * (rest)); /* verlager met aantal andere crits */
        } else if (crit2.getItem().equals("DeRu") || crit2.getItem().equals("Delusion Rune")) {
            int tel = countCritFamily(2, crit2.getFamily());
            int rest = CritAantal - tel;
            damage2 += (108 * (tel)); /* verhogen met aantal clerics */
            damage2 -= (34 * (rest)); /* verlager met aantal andere crits */
        } /* crit2: fiend */ else if (crit2.getItem().equals("FeIn") || crit2.getItem().equals("Ferocious Infusion")) {
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 250; /* verhogen */
            health2 += 250;
            damage2 -= (60 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (60 * (tel - 1));
        } else if (crit2.getItem().equals("BeIn") || crit2.getItem().equals("Berserker Infusion")) {
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 300; /* verhogen */
            health2 += 300;
            damage2 -= (75 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (75 * (tel - 1));
        } else if (crit2.getItem().equals("ThIn") || crit2.getItem().equals("Thrasher Infusion")) {
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 350; /* verhogen */
            health2 += 350;
            damage2 -= (85 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (85 * (tel - 1));
        } else if (crit2.getItem().equals("MaIn") || crit2.getItem().equals("Marauder Infusion")) {
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 400; /* verhogen */
            health2 += 400;
            damage2 -= (100 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (100 * (tel - 1));
        } else if (crit2.getItem().equals("MaIn") || crit2.getItem().equals("Mauler Infusion")) { /* ATTENTION ORI */
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 400; /* verhogen */
            health2 += 400;
            damage2 -= (100 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (100 * (tel - 1));
        } else if (crit2.getItem().equals("DeIn") || crit2.getItem().equals("Destroyer Infusion")) {
            int tel = countCritFamily(4, crit2.getName());
            int rest = CritAantal - tel;
            damage2 += 600; /* verhogen */
            health2 += 600;
            damage2 -= (150 * (tel - 1)); /* verlagen met aantal zelfde */
            health2 -= (150 * (tel - 1));
        }
        ...
        while (health1 > 0 && health2 > 0 && teller > 0) {
            ...
            /* crit1: golem */
            if (crit1.getItem().equals("StGu") || crit1.getItem().equals("Strawberry Gun")) {
                damage1 += 1;
            } else if (crit1.getItem().equals("GrAx") || crit1.getItem().equals("Granite Axe")) {
                double dam = damage1;
                dam = dam * 1.08;
                damage1 = (int) dam;
            } else if (crit1.getItem().equals("MaBl") || crit1.getItem().equals("Magma Blade")) {
                double dam = damage1;
                dam = dam * 1.10;
                damage1 = (int) dam;
            } else if (crit1.getItem().equals("PiRa") || crit1.getItem().equals("Pit Razor")) {
                double dam = damage1;
                dam = dam * 1.14;
                damage1 = (int) dam;
            } else if (crit1.getItem().equals("PiSc") || crit1.getItem().equals("Pit Scythe")) {
                double dam = damage1;
                dam = dam * 1.17;
                damage1 = (int) dam;
            } else if (crit1.getItem().equals("FeMa") || crit1.getItem().equals("Fear Mace")) {
                double dam = damage1;
                dam = dam * 1.20;
                damage1 = (int) dam;
            } else if (crit1.getItem().equals("NiCl") || crit1.getItem().equals("Nightmare Cleaver")) {
                double dam = damage1;
                dam = dam * 1.25;
                damage1 = (int) dam;
            } /* crit1: banshee */ else if (crit1.getItem().equals("AnCr") || crit1.getItem().equals("Anguish Cry")) {
                def2 -= 7;
            } else if (crit1.getItem().equals("ImCr") || crit1.getItem().equals("Impaler Cry")) {
                def2 -= 10;
            } else if (crit1.getItem().equals("StCr") || crit1.getItem().equals("Styx Cry")) {
                def2 -= 13;
            } else if (crit1.getItem().equals("DeLe") || crit1.getItem().equals("Destruction Leech")) {
                def2 -= 8;
                def1 += 4;
            } else if (crit1.getItem().equals("AbLe") || crit1.getItem().equals("Abyss Leech")) {
                def2 -= 10;
                def1 += 5;
            } /* crit2: golem */ else if (crit2.getItem().equals("StGu") || crit2.getItem().equals("Strawberry Gun")) {
                damage2 += 1;
            } else if (crit2.getItem().equals("GrAx") || crit2.getItem().equals("Granite Axe")) {
                double dam = damage2;
                dam = dam * 1.08;
                damage2 = (int) dam;
            } else if (crit2.getItem().equals("MaBl") || crit2.getItem().equals("Magma Blade")) {
                double dam = damage2;
                dam = dam * 1.10;
                damage2 = (int) dam;
            } else if (crit2.getItem().equals("PiRa") || crit2.getItem().equals("Pit Razor")) {
                double dam = damage2;
                dam = dam * 1.14;
                damage2 = (int) dam;
            } else if (crit2.getItem().equals("PiSc") || crit2.getItem().equals("Pit Scythe")) {
                double dam = damage2;
                dam = dam * 1.17;
                damage2 = (int) dam;
            } else if (crit2.getItem().equals("FeMa") || crit2.getItem().equals("Fear Mace")) {
                double dam = damage2;
                dam = dam * 1.20;
                damage2 = (int) dam;
            } else if (crit2.getItem().equals("NiCl") || crit2.getItem().equals("Nightmare Cleaver")) {
                double dam = damage2;
                dam = dam * 1.25;
                damage2 = (int) dam;
            } /* crit2: banshee */ else if (crit2.getItem().equals("AnCr") || crit2.getItem().equals("Anguish Cry")) {
                def1 -= 7;
            } else if (crit2.getItem().equals("ImCr") || crit2.getItem().equals("Impaler Cry")) {
                def1 -= 10;
            } else if (crit2.getItem().equals("StCr") || crit2.getItem().equals("Styx Cry")) {
                def1 -= 13;
            } else if (crit2.getItem().equals("DeLe") || crit2.getItem().equals("Destruction Leech")) {
                def1 -= 8;
                def2 += 4;
            } else if (crit2.getItem().equals("AbLe") || crit2.getItem().equals("Abyss Leech")) {
                def1 -= 10;
                def2 += 5;
            }
            /* end of items influence */
            ...
            /* speciaal items */
            /* crit1: carnage */
            if (crit1.getItem().equals("FaTo") || crit1.getItem().equals("Fallen Touch")) {
                schade2 = schade2 - ((21 - teller) * 32);
            } else if (crit1.getItem().equals("RoTo") || crit1.getItem().equals("Rotten Touch")) {
                schade2 = schade2 - ((21 - teller) * 58);
            } else if (crit1.getItem().equals("ShTo") || crit1.getItem().equals("Shadow Touch")) {
                schade2 = schade2 - ((21 - teller) * 75);
            } else if (crit1.getItem().equals("ToTo") || crit1.getItem().equals("Tormenter Touch")) {
                schade2 = schade2 - ((21 - teller) * 92);
            }
            /* crit2: carnage */
            if (crit2.getItem().equals("FaTo") || crit2.getItem().equals("Fallen Touch")) {
                schade1 = schade1 - ((21 - teller) * 32);
            } else if (crit2.getItem().equals("RoTo") || crit2.getItem().equals("Rotten Touch")) {
                schade1 = schade1 - ((21 - teller) * 58);
            } else if (crit2.getItem().equals("ShTo") || crit2.getItem().equals("Shadow Touch")) {
                schade1 = schade1 - ((21 - teller) * 75);
            } else if (crit2.getItem().equals("ToTo") || crit2.getItem().equals("Tormenter Touch")) {
                schade1 = schade1 - ((21 - teller) * 92);
            }
            ...
            /* item influence after battle */
            if (health1 > 0) {
                /* crit1: imling */
                if (crit1.getItem().equals("TiCh") || crit1.getItem().equals("Tiny Charm")) {
                    health1 += 50;
                    health2 -= 50;
                } else if (crit1.getItem().equals("SmCh") || crit1.getItem().equals("Small Charm")) {
                    health1 += 60;
                    health2 -= 60;
                } else if (crit1.getItem().equals("PuCh") || crit1.getItem().equals("Putrid Charm")) {
                    health1 += 70;
                    health2 -= 70;
                } else if (crit1.getItem().equals("RaCh") || crit1.getItem().equals("Rancid Charm")) {
                    health1 += 90;
                    health2 -= 90;
                } else if (crit1.getItem().equals("DiCh") || crit1.getItem().equals("Diamond Charm")) {
                    health1 += 120;
                    health2 -= 120;
                }
            }
            if (health2 > 0) {
                /* crit2: imling */
                if (crit2.getItem().equals("TiCh") || crit2.getItem().equals("Tiny Charm")) {
                    health2 += 50;
                    health1 -= 50;
                } else if (crit2.getItem().equals("SmCh") || crit2.getItem().equals("Small Charm")) {
                    health2 += 60;
                    health1 -= 60;
                } else if (crit2.getItem().equals("PuCh") || crit2.getItem().equals("Putrid Charm")) {
                    health2 += 70;
                    health1 -= 70;
                } else if (crit2.getItem().equals("RaCh") || crit2.getItem().equals("Rancid Charm")) {
                    health2 += 90;
                    health1 -= 90;
                } else if (crit2.getItem().equals("DiCh") || crit2.getItem().equals("Diamond Charm")) {
                    health2 += 120;
                    health1 -= 120;
                }
            }
    ...
    public boolean checkLogin(String uname, String pass) {
        ...
        try {
            ...
            URL sim = new URL("http://cq2.stormy.be/calcget/check.php?user=" + username + "&pass=" + pass + "&action=login");
        ...
        if (inputLine.equals("26a9a8f3c4ad002b7f39ae4c71a11972")) {
            return true;
        } else {
            return false;
        }
    ...
    public boolean ParseListRegExp(int listNum, BufferedReader in) {
        ...
        try {
            while ((str = in.readLine()) != null) {
                ...
                Pattern p0 = Pattern.compile("F\\d{1,3}/D\\d{1,3}/A\\d{1,3}/E\\d{1,3}");
                Matcher m0 = p0.matcher(str);
                ...
                if (str.length() > 0 && m0.find()) {
                    ...
                    /* klasse eruit halen */
                    p = Pattern.compile("earth|death|air|forest");
                    m = p.matcher(kant[0]);
                    m.find();
                    ...
                    /* familie eruit halen */
                    if (klasse.equals("air")) {
                        klas = 3;
                        p = Pattern.compile("Air Demon|Unholy Wyrm|Nether|Air Remnant|Angel|Balrog|Bat|Dragon|Gargoyle|Pit Wraith|Spirit|Storm|Rift Dancer/");

                    } else if (klasse.equals("death")) {
                        klas = 2;
                        p = Pattern.compile("Death Demon|Mistress of Death|Nether|Banshee|Carnage|Death Remnant|Devil|Diabolic Horde|Doomguard|Lich|Pit Worm|Reaper|Undead|Apocalypse/");

                    } else if (klasse.equals("earth")) {
                        klas = 4;
                        p = Pattern.compile("Earth Demon|Mountain Behemoth|Nether|Earth Remnant|Fiend|Giant|Golem|Imler|Imling|Rat|Smith|Tremor|Tempest/");

                    } else if (klasse.equals("forest")) {
                        klas = 1;
                        p = Pattern.compile("Forest Demon|Forest Gargantuan|Nether|Rabbit|Cleric|Ent|Forest Remnant|Hound|Hunter|Imp|Monk|Priest|Wolf|Seraph/");
                    }
                    ...
                    p = Pattern.compile("F\\d{1,3}");
                    m = p.matcher(kant[1]);
                    m.find();
                    int fdef = Integer.parseInt(m.group().replaceAll("F", ""));
                    ...
                    p = Pattern.compile("/A\\d{1,3}");
                    m = p.matcher(kant[1]);
                    m.find();
                    int adef = Integer.parseInt(m.group().replaceAll("/A", ""));
                    ...
                    p = Pattern.compile("F\\d{1,3}/D\\d{1,3}/A\\d{1,3}/E\\d{1,3}");
